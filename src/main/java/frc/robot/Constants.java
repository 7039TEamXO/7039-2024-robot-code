...
public final class Constants {
        public static class AutonomousConstants {
                ...
                public static AutoPoint[] middle_three = {
                                ...
                                new AutoPoint(new Pose2d(new Translation2d(0.92, 0), new Rotation2d(0)),
                                                RobotState.SUBWOOFER),
                                new AutoPoint(new Pose2d(new Translation2d(notesX + 0.3, 0), new Rotation2d(0)),
                                                RobotState.INTAKE),
                                new AutoPoint(new Pose2d(new Translation2d(notesX + 0.3, 0), new Rotation2d(0)),
                                                RobotState.PODIUM),
                                // 2ND
                                new AutoPoint(new Pose2d(new Translation2d(2, 0), new Rotation2d(0)),
                                                RobotState.TRAVEL),
                                new AutoPoint(new Pose2d(new Translation2d(1.6, yBetweenNotes), new Rotation2d(0)),
                                                RobotState.TRAVEL),
                                new AutoPoint(new Pose2d(new Translation2d(2.2, yBetweenNotes), new Rotation2d(0)),
                                                RobotState.INTAKE),
                                new AutoPoint(new Pose2d(new Translation2d(1, 0), new Rotation2d(0)),
                                                RobotState.INTAKE),
                                new AutoPoint(new Pose2d(new Translation2d(1, 0), new Rotation2d(0)),
                                ...
                                new AutoPoint(new Pose2d(new Translation2d(1.6, -yBetweenNotes), new Rotation2d(0)),
                                                RobotState.INTAKE),
                                new AutoPoint(new Pose2d(new Translation2d(2.5, -yBetweenNotes), new Rotation2d(0)),
                                                RobotState.INTAKE),
                                new AutoPoint(new Pose2d(new Translation2d(0.8, 0.2), new Rotation2d(0)),
                                                RobotState.INTAKE),
                                new AutoPoint(new Pose2d(new Translation2d(0.8, 0.2), new Rotation2d(0)),
                                                RobotState.SUBWOOFER),
                ...
                public static AutoPoint[] feeder_blue = {
                                ...
                                new AutoPoint(new Pose2d(new Translation2d(3.3, -2.1),
                                                new Rotation2d(Math.toRadians(-50))),
                                                RobotState.PODIUM),
                                new AutoPoint(new Pose2d(new Translation2d(9, -yBetweenNotes + 0.2),
                                                new Rotation2d(Math.toRadians(0))),
                                                RobotState.INTAKE),
                                new AutoPoint(new Pose2d(new Translation2d(6, -1.75),
                                                new Rotation2d(Math.toRadians(0))),
                                                RobotState.TRAVEL),
                                new AutoPoint(new Pose2d(new Translation2d(3.3, -2.1),
                                                new Rotation2d(Math.toRadians(0))),
