...
public final class Constants {
    public static class AutonomousConstants {
        ...
        public static AutoPoint[] right_one = {
                ...
                new AutoPoint(new Pose2d(new Translation2d(0.92, -1), new Rotation2d(Math.toRadians(-45))),
                        RobotState.TRAVEL),
                new AutoPoint(new Pose2d(new Translation2d(0.92, -1), new Rotation2d(Math.toRadians(-45))),
        ...
        public static AutoPoint[] feeder_red = {
                new AutoPoint(new Pose2d(new Translation2d(1.44, 2), new Rotation2d(0)), RobotState.TRAVEL),
                new AutoPoint(new Pose2d(new Translation2d(3.3, 2.1), new Rotation2d(0)), RobotState.TRAVEL),
                new AutoPoint(new Pose2d(new Translation2d(3.3, 2.1), new Rotation2d(Math.toRadians(45))),
                        RobotState.TRAVEL),
                new AutoPoint(new Pose2d(new Translation2d(3.3, 2.1), new Rotation2d(Math.toRadians(45))),
                        RobotState.PODIUM),
                new AutoPoint(new Pose2d(new Translation2d(9, yBetweenNotes), new Rotation2d(Math.toRadians(0))),
                        RobotState.INTAKE),
                new AutoPoint(new Pose2d(new Translation2d(6, 2.1), new Rotation2d(Math.toRadians(0))),
                        RobotState.TRAVEL),
                new AutoPoint(new Pose2d(new Translation2d(3.3, 2.1), new Rotation2d(Math.toRadians(0))),
                        RobotState.TRAVEL),
                new AutoPoint(new Pose2d(new Translation2d(3.3, 2.1), new Rotation2d(Math.toRadians(45))),
                        RobotState.TRAVEL),
                new AutoPoint(new Pose2d(new Translation2d(3.3, 2.1), new Rotation2d(Math.toRadians(45))),
        ...
        public static AutoPoint[] feeder_blue = {
                new AutoPoint(new Pose2d(new Translation2d(1.44, -2), new Rotation2d(0)), RobotState.TRAVEL),
                new AutoPoint(new Pose2d(new Translation2d(3.3, -2.1), new Rotation2d(0)), RobotState.TRAVEL),
                new AutoPoint(new Pose2d(new Translation2d(3.3, -2.1), new Rotation2d(Math.toRadians(-50))),
                        RobotState.TRAVEL),
                new AutoPoint(new Pose2d(new Translation2d(3.3, -2.1), new Rotation2d(Math.toRadians(-50))),
                        RobotState.PODIUM),
                new AutoPoint(new Pose2d(new Translation2d(9, -yBetweenNotes + 0.2), new Rotation2d(Math.toRadians(0))),
                        RobotState.INTAKE),
                new AutoPoint(new Pose2d(new Translation2d(6, -1.75), new Rotation2d(Math.toRadians(0))),
                        RobotState.TRAVEL),
                new AutoPoint(new Pose2d(new Translation2d(3.3, -2.1), new Rotation2d(Math.toRadians(0))),
                        RobotState.TRAVEL),
                new AutoPoint(new Pose2d(new Translation2d(3.3, -2.1), new Rotation2d(Math.toRadians(-50))),
