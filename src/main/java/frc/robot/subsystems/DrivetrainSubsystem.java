...
public class DrivetrainSubsystem extends SubsystemBase {
    ...
    public static final double MAX_ANGULAR_VELOCITY_RADIANS_PER_SECOND = MAX_VELOCITY_METERS_PER_SECOND /
            Math.hypot(Constants.DriveConstants.DRIVETRAIN_TRACKWIDTH_METERS / 2.0, Constants.DriveConstants.DRIVETRAIN_WHEELBASE_METERS / 2.0);
    ...
    private final SwerveDriveKinematics kinematics = new SwerveDriveKinematics(
            new Translation2d(Constants.DriveConstants.DRIVETRAIN_TRACKWIDTH_METERS / 2.0, Constants.DriveConstants.DRIVETRAIN_WHEELBASE_METERS / 2.0),
            new Translation2d(Constants.DriveConstants.DRIVETRAIN_TRACKWIDTH_METERS / 2.0, -Constants.DriveConstants.DRIVETRAIN_WHEELBASE_METERS / 2.0),
            new Translation2d(-Constants.DriveConstants.DRIVETRAIN_TRACKWIDTH_METERS / 2.0, Constants.DriveConstants.DRIVETRAIN_WHEELBASE_METERS / 2.0),
            new Translation2d(-Constants.DriveConstants.DRIVETRAIN_TRACKWIDTH_METERS / 2.0, -Constants.DriveConstants.DRIVETRAIN_WHEELBASE_METERS / 2.0)
    );
    ...
    public DrivetrainSubsystem() {
        ...
        frontLeftModule = new MkSwerveModuleBuilder()
                ...
                .withDriveMotor(MotorType.FALCON, Constants.DriveConstants.FRONT_LEFT_MODULE_DRIVE_MOTOR)
                .withSteerMotor(MotorType.FALCON, Constants.DriveConstants.FRONT_LEFT_MODULE_STEER_MOTOR)
        ...
        frontRightModule = new MkSwerveModuleBuilder()
                .withLayout(shuffleboardTab.getLayout("Front Right Module", BuiltInLayouts.kList)
                        ...
                        .withPosition(2, 0))
                .withGearRatio(SdsModuleConfigurations.MK4_L2)
                .withDriveMotor(MotorType.FALCON, Constants.DriveConstants.FRONT_RIGHT_MODULE_DRIVE_MOTOR)
                .withSteerMotor(MotorType.FALCON, Constants.DriveConstants.FRONT_RIGHT_MODULE_STEER_MOTOR)
        ...
        backRightModule = new MkSwerveModuleBuilder()
                .withLayout(shuffleboardTab.getLayout("Back Right Module", BuiltInLayouts.kList)
                        ...
                        .withPosition(6, 0))
                .withGearRatio(SdsModuleConfigurations.MK4_L2)
                .withDriveMotor(MotorType.FALCON, Constants.DriveConstants.BACK_RIGHT_MODULE_DRIVE_MOTOR)
                .withSteerMotor(MotorType.FALCON, Constants.DriveConstants.BACK_RIGHT_MODULE_STEER_MOTOR)
        ...
        shuffleboardTab.addNumber("Gyroscope Yaw", () -> gyroscope.getYaw());
