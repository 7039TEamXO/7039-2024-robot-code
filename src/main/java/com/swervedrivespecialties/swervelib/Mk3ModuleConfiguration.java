 ...
 * Each setting is initialized to a default tha200+320020t should be adequate for most use cases.
 */
public class Mk3ModuleConfiguration {
    private double nominalVoltage = 12.0;
    private double driveCurrentLimit = DriveConstants.CurrentLimtDrive; //default - 80
    private double steerCurrentLimit = DriveConstants.CurrentLimtSteer; //default 20
